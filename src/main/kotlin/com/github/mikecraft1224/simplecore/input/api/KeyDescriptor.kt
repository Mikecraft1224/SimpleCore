...
data class KeyDescriptor(
    ...
    companion object {
         ...
         * and modifier flags.
         *
         * This removes the need to manually unpack [Keybind.keyCode] and reconstruct modifiers:
         * ```kotlin
         * // Before:
         * KeyDescriptor.keyboard(config.configKey.keyCode)
         *
         * // After:
         * KeyDescriptor.from(config.configKey)
         * ```
         */
